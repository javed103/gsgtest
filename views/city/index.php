...
if (\Yii::$app->user->can('app_city_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
}

if (\Yii::$app->user->can('app_city_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
}

if (\Yii::$app->user->can('app_city_delete', ['route' => true])) {
...
<?php
if(\Yii::$app->user->can('app_city_create', ['route' => true])){
?>
        <div class="pull-left">
