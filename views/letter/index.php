...
$this->title = Yii::t('models', 'Letters');
...
if (\Yii::$app->user->can('app_letter_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
}

if (\Yii::$app->user->can('app_letter_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
}

if (\Yii::$app->user->can('app_letter_delete', ['route' => true])) {
...
?>
<div class="giiant-crud letter-index">
...
<?php
if(\Yii::$app->user->can('app_letter_create', ['route' => true])){
?>
        <div class="pull-left">
