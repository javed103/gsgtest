...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var app\models\BankDetailsSearch $searchModel
*/
...
if (\Yii::$app->user->can('app_bank-details_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
}

if (\Yii::$app->user->can('app_bank-details_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
}

if (\Yii::$app->user->can('app_bank-details_delete', ['route' => true])) {
...
?>
<div class="giiant-crud bank-details-index">
...
<?php
if(\Yii::$app->user->can('app_bank-details_create', ['route' => true])){
?>
        <div class="pull-left">
